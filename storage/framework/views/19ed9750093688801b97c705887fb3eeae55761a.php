...
<?php $__env->startSection('content'); ?>
    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="<?php echo e($tvshow['poster_path']); ?>" alt="poster" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24">
            <div class="container">
  ...
  <?php endif; ?>
                ...
                <div x-data="{ isOpen: false }">
                        <div class="mt-12">
                            ...
                            <?php if($tvshow['id']===94997): ?>
                           <?php $id=6  ?>
                           <?php endif; ?>
                           <?php if($tvshow['id']===84773): ?>
                           <?php $id=7  ?>
                           <?php endif; ?>
                           <?php if($tvshow['id']===92783): ?>
                           <?php $id=8  ?>
                           <?php endif; ?>
                           <?php if($tvshow['id']===77169): ?>
                           <?php $id=9  ?>
                           <?php endif; ?>
                           <?php if($tvshow['id']===60625): ?>
                           <?php $id=10  ?>
                           <?php endif; ?>
                           ...
                           <?php if(Session::has('user')): ?>
                              <button
                                ...
                                <a href="<?php echo e(route('add.to.cart',$id )); ?>"><span class="ml-1">Add to cart</span></a>                           
                              </button>   
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\movieproject\resources\views/tv/show.blade.php ENDPATH**/ ?>