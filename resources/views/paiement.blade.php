...
<input type="button" onclick="location.href='{{route ('Payzone.payment',$total)}}';" value="Pay card" class="affichage"/>
<input type="button" onclick="location.href='{{route ('Payexpress.payment',$total)}}';" value="Pay in cash" class="affichage1"/>
