...
class Connect2PayexpressPos
{
     ...
     * PAYMENT REFUND MTI
     */
    const _PAYMENT_REFUND_MTI = '3104';
    /**
     * PAYMENT REFUND TC
     */
    const _PAYMENT_REFUND_TC = '04';

    /**
     * STATUS REFUND MTI
     */
    const _STATUS_REFUND_MTI = '3105';
    /**
     * STATUS REFUND TC
     */
    const _STATUS_REFUND_TC = '00';
    ...
    /**
     * CALLBACK REFUND STATUS MTI
     */
    const _CALLBACK_REFUND_STATUS_MTI = '3105';
    /**
     * CALLBACK REFUND STATUS TC
     */
    const _CALLBACK_REFUND_STATUS_TC = '00';
    ...
    /**
     * CALLBACK REFUND STATUS RESPONSE MTI
     */
    const _CALLBACK_REFUND_STATUS_RESPONSE_MTI = '4105';
    /**
     * CALLBACK REFUND STATUS RESPONSE TC
     */
    const _CALLBACK_REFUND_STATUS_RESPONSE_TC = '01';
    ...
    /**
     * Document identification client type
     *
     *    - '0' : CINE
     */
     ...
     *    - '0' : Only total refund
     */
    const _REFUND_CONDITION_TOTAL_ONLY = '0';

    /**
     * Refund condition
     *    - '1' : Partial only once
     */
    const _REFUND_CONDITION_PARTIAL_ONLY_ONCE = '1';

    /**
     * Refund condition
     *    - '2' : Partial several times
     */
    const _REFUND_CONDITION_PARTIAL_SEVERAL_TIMES = '2';

    /**
     * Refund condition
     *    - '3' : Follow POS configuration
     */
    const _REFUND_CONDITION_FOLLOW_POS_CONFIG = '3';

    /**
     * Refund advice option
     *    - '0' : No
     */
    const _REFUND_ADVICE_OPTION_NO = '0';
    /**
     * Refund advice option
     *    - '1' : Send SMS, charged to customer
     */
    const _REFUND_ADVICE_OPTION_CHARGED_CUSTOMER = '1';
    /**
     * Refund advice option
     *    - '2' : Send SMS, charged to POS
     */
    const _REFUND_ADVICE_OPTION_CHARGED_POS = '2';
    /**
     * Refund advice
     *    - '3' : Follow POS configuration
     */
    const _REFUND_ADVICE_OPTION_FOLLOW_POS_CONFIG = '3';

    /**
     * Refund condition fees
     *    - '0' : Charged to merchant only
     */
    const _REFUND_CONDITION_FEES_MERCHANT = '0';
    /**
     * Refund condition fees
     *    - '1' : Charged to client only
     */
    const _REFUND_CONDITION_FEES_CLIENT = '1';
    /**
     * Refund condition fees
     *    - '2' : Shared between merchant and client
     */
    const _REFUND_CONDITION_FEES_MERCHANT_AND_CLIENT = '2';
    ...
    private $request_required_fields = array(
        'resa_request' => [
            'mti', 'tc', 'ws_version', 'pos_id', 'language', 'customer_name', 'customer_city_id',
            'send_custom_mail', 'transaction_amount', 'transmission_datetime', 'sender_mac_index', 'sender_mac'
        ],
        'resa_cancel' => [
            'mti', 'tc', 'ws_version', 'acquirer_id', 'pos_id', 'provider_code', 'language',
            'transmission_datetime', 'sender_mac_index', 'sender_mac'
        ],
        'resa_check' => [
            'mti', 'tc', 'ws_version', 'acquirer_id', 'pos_id', 'language',
            'transmission_datetime', 'sender_mac_index', 'sender_mac'
        ],
        'payment_refund' => [
            'mti', 'tc', 'ws_version', 'acquirer_id', 'pos_id', 'language', 'token',
            'refund_conditions_proc', 'refund_conditions_fees', 'refund_amount',
            'refund_advice', 'transmission_datetime', 'sender_mac_index', 'sender_mac'
        ],
        'status_refund' => [
            'mti', 'tc', 'ws_version', 'acquirer_id', 'pos_id', 'language', 'token',
            'refund_nen_token', 'customer_name', 'customer_surname', 'transmission_datetime', 'sender_mac_index', 'sender_mac'
        ],
        'ping' => [
            'mti', 'tc', 'ws_version', 'acquirer_id', 'pos_id', 'provider_code', 'language',
            'transmission_datetime', 'sender_mac_index', 'sender_mac'
    ...
    private $fields_size = array(
        ...
        'customer_name' => '64', 'customer_surname' => '64', 'customer_id_type' => '1', 'customer_id' => '16', 'customer_phone' => '20',
        'customer_email' => '64', 'customer_birth_date' => '20', 'customer_zip_code' => '10', 'customer_address' => '128',
        'customer_country_code' => '3', 'customer_city_id' => '10', 'send_custom_mail' => '1', 'token' => '18',
    ...
    private $fields_validate = array(
        ...
        'customer_title' => 'isString', 'customer_name' => 'isName', 'customer_surname' => 'isName', 'customer_id_type' => 'isNumericString',
        ...
        'customer_country_code' => 'isCountryCode', 'customer_city_id' => 'isCityName', 'send_custom_mail' => 'isNumericString',
        ...
        'url1' => 'isUrl', 'url2' => 'isUrl', 'url3' => 'isUrl', 'url4' => 'isUrl', 'url5' => 'isUrl', 'url6' => 'isUrl',
        'url7' => 'isUrl', 'refund_nen_token' => 'isString', 'refund_conditions_proc' => 'isNumericString', 'refund_conditions_fees' => 'isFloat',
        'refund_amount' => 'isFloat', 'refund_advice' => 'isNumericString', 'refund_private_data' => 'isString',
    ...
    private $webservice_fields = array(
        ...
        'pos_book_date', 'language', 'customer_title', 'customer_name', 'customer_surname', 'customer_id_type', 'customer_id',
        'customer_phone', 'customer_email', 'customer_birth_date', 'customer_zip_code', 'customer_address',
        'customer_country_code', 'customer_city_id', 'send_custom_mail', 'token', 'good_service_desc',
        'transaction_datetime', 'validity_reservation_datetime', 'validity_reservation_status', 'currency_code',
        'transaction_amount', 'url1', 'url2', 'url3', 'url4', 'url5', 'url6', 'url7', 'refund_nen_token', 'refund_conditions_proc',
        'refund_conditions_fees', 'refund_amount', 'refund_advice', 'refund_private_data', 'pos_private_data',
        'transmission_datetime', 'response_code', 'response_message', 'sender_mac_index', 'sender_mac',
    );
    ...
    /**
     * Point Of Sale (POS) book ID (e.g. order ID)
     * @var string(64)
     */
    private $pos_book_id;

    /**
     * Point Of Sale (POS) book date (e.g. order date)
     * @var string(20)
     */
     ...
     * Can be country name or ISO code
     * @var string(32)
     */
    private $customer_country_code;

    /**
     * Customer city name or code
     * @var string(10)
     */
     ...
     *
     *    - '0' : No
     *    - '1' : Yes, send reservation email
     *
     * @var string(1)
     */
    private $send_custom_mail;
    ...
    /**
     * Validity reservation date time
     * @var string(20)
     */
    private $validity_reservation_datetime;

    /**
     * Validity reservation status
     * @var string(1)
     */
    ...
    /**
     * On ResaRequest (Captcha) : Return link to the Merchant site<br>
     * On Response : Link to HTML document Reservation
     * @var string(255)
     */
    private $url1;

    /**
     * On ResaRequest(Captcha) : Callback Confirmation WS URL .<br>
     * On Response : Link to PDF document Reservation
     * @var string(255)
     */
    private $url2;

    /**
     * On ResaRequest : Callback Checking Resa.<br>
     * On Response : Link to HTML document Transaction
     * @var string(255)
     */
    private $url3;
     ...
     * Response : Link to PDF document Transaction
     * @var string(255)
     */
    private $url4;
     ...
     * @var string(20)
     */
    private $refund_nen_token;

    /**
     * Refund condition indicator<br>
     * Indicate if the refund request is a : <br>
     *    0 - Total refund, no other refund can be applied to the initial token
     *    1 - Partial refund, once time and no other refund can be applied to the initial token
     *    2 - Partial refund, one or many refund can be applied to the initial token
     *    3 - Follow POS configuration
     * @var string(1)
     */
    private $refund_conditions_proc;

    /**
     * Refund condition fees<br>
     * @var float(6.4)
     */
    private $refund_conditions_fees;

    /**
     * Refund amount<br>
     * Can't exceed initial token amount
     * @var float(9.2)
     */
    ...
    /**
     * Refund advice<br>
     * Indicate if SMS advice will be sent and who will be charged for
     *    0 - No SMS
     *    1 - Send SMS, charged to customer
     *    2 - Send SMS, charged to POS
     *    3 - Follow POS configuration
     * @var string(1)
     */
    private $refund_advice;

    /**
     * Refund private data<br>
     * Returned back on refund status advice
     * @var string(128)
     */
    private $refund_private_data;

    /**
     * POS private data
     * Returned back on Checking and Payment callbacks
     * @var string(1024)
     */
    ...
    {
        if (!C2PValidate::isUrl($webservice_url))
    ...
    public function cancelReservation($reservation_id, $as = self::_RESERVATION_ID_AS_TOKEN)
    {
        ...
        if ($as == self::_RESERVATION_ID_AS_TOKEN) {
            $this->token = $reservation_id;
        } elseif ($as == self::_RESERVATION_ID_AS_POS_BOOK_ID) {
            $this->pos_book_id = $reservation_id;
        } else {
            $this->error_message = 'function parameter (as) don\'t match';
            return false;
        }
    ...
    public function checkReservation($reservation_id, $as = self::_RESERVATION_ID_AS_TOKEN)
    {
        ...
        $this->transmission_datetime = date(self::_DATE_FORMAT);
        $this->acquirer_public_key = ($this->sender_mac_index == '1') ? $this->acquirer_public_ : $this->acquirer_public_input_key_2;
     ...
     * Refund a payment
     *
     * This function allows merchant to generate refund for already paid tokens based on a $token.
     *
     * @param string $token already paid token
     * @return bool true if the refund generated successfully, otherwise false
     * @example PACKAGE_DIR/Examples/refundPayment.php
     */
    public function refundPayment($token)
    {
        $this->mti = self::_PAYMENT_REFUND_MTI;
        $this->tc = self::_PAYMENT_REFUND_TC;
        ...
        return $this->initRequest($this->request_required_fields['payment_refund']);
    }

    /**
     * Status refund
     *
     * This function allows merchant to get refund status.
     *
     * @param string $token already paid token
     * @param string $refund_nen_token
     * @return bool
     * @example PACKAGE_DIR/Examples/statusRefund.php
     */
    public function statusRefund($token, $refund_nen_token)
    {
        $this->mti = self::_STATUS_REFUND_MTI;
        $this->tc = self::_STATUS_REFUND_TC;

        $this->token = $token;
        $this->refund_nen_token = $refund_nen_token;
        ...
        return $this->initRequest($this->request_required_fields['status_refund']);
    }
    ...
    private function validateFields($fields_required)
    {
        ...
        foreach ($this->fields_validate as $field => $method) {
            if (!C2PValidate::isEmpty($this->{$field}) and !call_user_func(array('Payexpress\C2PValidate', $method), $this->{$field}))
     ...
     * @return string
     */
    public function getSendCustomMail()
    {
        return $this->send_custom_mail;
    }

    /**
     * @param string $send_custom_mail
     */
    public function setSendCustomMail($send_custom_mail)
    {
        $this->send_custom_mail = $send_custom_mail;
    }
     ...
     * @return string
     */
    public function getRefundNenToken()
    {
        return $this->refund_nen_token;
    }

    /**
     * @param string $refund_nen_token
     */
    public function setRefundNenToken($refund_nen_token)
    {
        $this->refund_nen_token = $refund_nen_token;
    }
     ...
     * @return string
     */
    public function getRefundConditionsProc()
    {
        return $this->refund_conditions_proc;
    }

    /**
     * @param string $refund_conditions_proc
     */
    public function setRefundConditionsProc($refund_conditions_proc)
    {
        $this->refund_conditions_proc = $refund_conditions_proc;
    }

    /**
     * @return float
     */
    public function getRefundConditionsFees()
    {
        return $this->refund_conditions_fees;
    }

    /**
     * @param float $refund_conditions_fees
     */
    public function setRefundConditionsFees($refund_conditions_fees)
    {
        $this->refund_conditions_fees = $refund_conditions_fees;
    }
     ...
     * @return string
     */
    public function getRefundPrivateData()
    {
        return $this->refund_private_data;
    }

    /**
     * @param string $refund_private_data
     */
    public function setRefundPrivateData($refund_private_data)
    {
        $this->refund_private_data = $refund_private_data;
    }
